...
type Props = NativeStackScreenProps<RootStackParamList, 'DriverNotifications'>;
...
export function DriverNotificationsScreen({ navigation }: Props) {
  const { user } = useAuth();
      ...
      items = [
        {
          ...
          msg: 'New pickup requests and delivery updates will appear here.',
          time: 'Just now',
          createdAt: Date.now(),
          read: false,
        },
